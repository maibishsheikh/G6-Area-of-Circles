...
const JOURNEY = [
  { num: '01', icon: '🔍', label: 'Wonder',   desc: 'The pizza box puzzle' },
  { num: '02', icon: '📖', label: 'Story',    desc: 'Zoe & Arjun\'s exhibits (6 panels)' },
  { num: '03', icon: '🧪', label: 'Simulate', desc: '4 interactive challenge labs' },
  ...
  return (
    <div className="intro-wrap">
      ...
      <h1 className="intro-title">
        <span className="text-orange">Circle</span> <span className="text-white">Quest</span>
      </h1>
      <h2 className="intro-subtitle">CircleQuest · Master Radius, π, Area &amp; Composite Figures</h2>
      ...
      <div className="intro-bottom-cards">
        ...
        <div className="bottom-card">
          <div className="bottom-card-icon" style={{ color: '#4fc3f7' }}>⚪</div>
          <div>Circles &amp; Tracks</div>
        </div>
        <div className="bottom-card">
