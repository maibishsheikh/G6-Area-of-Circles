...
const REFLECT_QUESTIONS = [
  {
    q: "1. If you double the radius of a circle, what happens to its area?",
    options: [
      "It becomes 4 times as large (quadrupled)",
      "It becomes 2 times as large (doubled)",
      "It stays the same",
    ],
    correct: 0,
  },
  {
    q: "2. What is the formula for the area of a circle with radius r?",
    options: [
      "Area = π × radius × radius (πr²)",
      "Area = 2 × π × radius (2πr)",
      "Area = π × diameter",
    ],
    correct: 0,
  ...
  {
    q: "3. A semicircle's area is what fraction of a full circle with the same radius?",
    options: [
      "One half (½ of πr²)",
      "One quarter (¼ of πr²)",
      "The same as a full circle",
    ],
    correct: 0,
  },
];
    ...
    return (
      <div className="reflect-wrap">
        <div className="trophy-card glass-card anim-bounce-in">
          ...
          <h1 className="trophy-title headline">You're a Circle Grand Master!</h1>
          <p className="trophy-sub subheadline" style={{ color: 'var(--gold)' }}>
            Area of Circles, Semicircles &amp; Composite Figures Mastery Complete ✅
          </p>
    ...
    <div className="reflect-wrap">
      <div className="reflect-card glass-card anim-slide-up">
        <div className="reflect-header">
          ...
          <h2 className="reflect-title subheadline">Reflect on Your Circle Journey</h2>
        </div>
        ...
        <div className="reflect-quiz-container">
          <p className="body-text" style={{ color: 'var(--gold)', fontWeight: 800 }}>
            🧠 Circle Concept Reflection Check:
          </p>
        ...
        <div className="reflect-journal">
          <label className="reflect-label body-text" htmlFor="journal-input">
            Write one key circle rule or formula you mastered:
          </label>
          <textarea
            id="journal-input"
            className="reflect-textarea"
            placeholder="e.g. Area = π × r², and doubling the radius makes the area 4 times bigger!"
            value={journal}
          ...
          <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginTop: '6px' }}>
            ...
            {[
              'Area = π × r²',
              'Doubling radius makes area 4× bigger!',
              'Two semicircles = One full circle',
              'Shaded Area = Total Shape − Cutout',
            ].map((ex) => (
              <button
                key={ex}
                type="button"
